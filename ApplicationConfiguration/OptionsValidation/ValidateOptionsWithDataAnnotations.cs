...
public class ValidateOptionsWithDataAnnotations
{
	...
	public void Should_fail_validation()
	{
		...
		Assert.Collection(error.Failures,
				f => Assert.Equal(
					"DataAnnotation validation failed for 'Options' members: 'MyImportantProperty' with the error: 'The MyImportantProperty field is required.'.",
					f)
			);
	}
	...
	{
		[Required] public string? MyImportantProperty { get; set; }
	}
}