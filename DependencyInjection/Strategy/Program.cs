...
#if DEPLOY_TO_PROD
builder.Services
   .AddSingleton<IDatabase,
		NotImplementedDatabase>(); // The NotImplementedDatabase throws a NotImplementedException; injected into SqlLocationService.
builder.Services
   .AddSingleton<ILocationService,
		SqlLocationService>(); // Good for: InjectAbstractionLocationsController and InjectAbstractionUpdatedLocationsController
