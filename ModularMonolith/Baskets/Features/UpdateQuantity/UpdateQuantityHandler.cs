...
public class UpdateQuantityHandler
{
	...
	public async Task<UpdateQuantityResponse> HandleAsync(UpdateQuantityCommand command,
														  CancellationToken cancellationToken)
	{
		...
		if (item is null) throw new BasketItemNotFoundException(command.ProductId);
