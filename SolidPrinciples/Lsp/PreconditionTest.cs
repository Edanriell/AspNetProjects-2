...
{
	public static TheoryData<SuperClass> InstancesThatThrowsSuperExceptions = new()
																			  {
																				  // value < 0
																				  new SuperClass(),
	...
	public class SubClassOk : SuperClass
	{
		...
		{
			if (value < -10) throw new ArgumentException("Value must be greater or equal to -10.", nameof(value));
			return true;
		}
	}
