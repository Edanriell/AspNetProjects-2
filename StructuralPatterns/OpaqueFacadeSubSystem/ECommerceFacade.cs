...
public class ECommerceFacade : IECommerceOpaqueFacade
{
	...
	internal ECommerceFacade(InventoryService inventoryService, OrderProcessingService orderProcessingService,
							 ShippingService shippingService)
	{
		_inventoryService = inventoryService ?? throw new ArgumentNullException(nameof(inventoryService));
		_orderProcessingService =
			orderProcessingService ?? throw new ArgumentNullException(nameof(orderProcessingService));
